...
export UNIFYCR_META_SERVER_RATIO=1 #determines the number of range servers in the key-value store
...
#  rsh ${remote_host} "rm -rf /tmp/unifycr*; rm /dev/shm/*; rm /tmp/mdhim*" #clear the leftovers from previous daemon
#done
