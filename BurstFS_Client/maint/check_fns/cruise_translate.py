...
''' a modified version of Elsa's translate.py script here: 
    ...
    and writes out the CRUISE_DEF macros  

    to generate gotcha header run the following: python cruise_translate.py cruise_list    
'''
class func:
	...
	def __init__(self, prototype):
		...
		self.wrap_macro = x[-1]
                self.real_macro = "CRUISE_REAL" 
                self.macro_def  = "CRUISE_DEF"        
		self.name = l[1].strip(")")
