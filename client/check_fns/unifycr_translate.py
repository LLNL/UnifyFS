...
''' a modified version of Elsa's translate.py script here: 
    ...
    and writes out the UNIFYCR_DEF macros  

    to generate gotcha header run the following: python unifycr_translate.py unifycr_list    
'''
class func:
	...
	def __init__(self, prototype):
		...
		self.wrap_macro = x[-1]
                self.real_macro = "UNIFYCR_REAL" 
                self.macro_def  = "UNIFYCR_DEF"        
		self.name = l[1].strip(")")
