...
UNIFYCR_DECL(freopen, FILE *, (const char *path, const char *mode,
                               FILE *stream));
...
UNIFYCR_DECL(fread,  size_t, (void *ptr, size_t size, size_t nitems,
                              FILE *stream));
UNIFYCR_DECL(fwrite, size_t, (const void *ptr, size_t size, size_t nitems,
                              FILE *stream));
...
UNIFYCR_DECL(vfwprintf, int, (FILE *stream, const wchar_t *format,
                              va_list arg));
UNIFYCR_DECL(vfwscanf,  int, (FILE *stream, const wchar_t *format,
                              va_list arg));
