...
UNIFYCR_DECL(pread64, ssize_t, (int fd, void *buf, size_t count, off64_t offset));
UNIFYCR_DECL(pwrite, ssize_t, (int fd, const void *buf, size_t count, off_t offset));
UNIFYCR_DECL(pwrite64, ssize_t, (int fd, const void *buf, size_t count, off64_t offset));
...
UNIFYCR_DECL(mmap, void*, (void *addr, size_t length, int prot, int flags, int fd, off_t offset));
UNIFYCR_DECL(mmap64, void*, (void *addr, size_t length, int prot, int flags, int fd, off64_t offset));
...
int unifycr_fd_read(int fd, off_t pos, void* buf, size_t count, size_t* retcount);
